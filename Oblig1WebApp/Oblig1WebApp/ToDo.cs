...
namespace Oblig1WebApp
{
    public class ToDo
    {
        ...
        //Legge til mere funksjonalitet som å liste alle brukere, slette bruker, endre bruker (?)
